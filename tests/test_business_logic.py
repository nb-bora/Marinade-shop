...
class TestPaymentMethods:
    ...
    def test_cash_payment_success(self):
        ...
        result = cash_payment.process_payment(
            ...
            payment_details={"received_by": "serveur_1", "currency": "XAF"},
        )
    ...
    def test_cash_payment_invalid_amount(self):
        ...
        cash_payment = CashPayment()
        result = cash_payment.process_payment(
            amount=Decimal("-100.00"), payment_details={"amount": -100}
        )
    ...
    def test_orange_money_requires_easytransact(self):
        ...
        result = orange_payment.process_payment(
            ...
            payment_details={"phone_number": "+237655123456", "currency": "XAF"},
        )
    ...
    def test_orange_money_validation(self):
        ...
        assert (
            orange_payment.validate_payment_details(
                {"phone_number": "+237655123456", "amount": 1000}
            )
            == True
        )
        ...
        assert (
            orange_payment.validate_payment_details({"phone_number": "invalid"})
            == False
        )
        # Landline / non-mobile prefix
        assert (
            orange_payment.validate_payment_details({"phone_number": "+237123456789"})
            == False
        )
        # MTN number is not an Orange number
        assert (
            orange_payment.validate_payment_details({"phone_number": "+237650123456"})
            == False
        )
    ...
    def test_mobile_money_requires_easytransact(self):
        ...
        result = mobile_payment.process_payment(
            ...
            payment_details={"phone_number": "+237650123456", "currency": "XAF"},
        )
    ...
    def test_mobile_money_validation_is_operator_scoped(self):
        ...
        assert (
            orange.validate_payment_details({"phone_number": "+237655123456"}) == True
        )
        # Without a declared provider the adapter cannot be used.
        assert (
            undeclared.validate_payment_details({"phone_number": "+237650123456"})
            == False
        )
...
class TestPaymentService:
    ...
    def test_payment_service_orange_money(self):
        ...
        result = payment_service.process_payment(
            ...
            amount=Decimal("3000.00"),
            payment_details={"phone_number": "+237123456789", "currency": "XAF"},
        )
    ...
    def test_payment_service_invalid_method(self):
        ...
        result = payment_service.process_payment(
            method_type="bitcoin", amount=Decimal("1000.00"), payment_details={}
        )
...
class TestNotificationChannels:
    ...
    def test_email_notification(self):
        ...
        result = email_notification.send_notification(
            recipient="test@example.com", subject="Test Subject", message="Test message"
        )
    ...
    def test_email_validation(self):
        ...
        assert (
            email_notification.validate_recipient("user.name+tag@domain.co.uk") == True
        )
