...
class EmailNotification(NotificationChannel):
    ...
    def send_notification(
        ...
        final_message = self._apply_template(message, template_data) if template_data else message
        final_subject = self._apply_template(subject, template_data) if template_data else subject
    ...
    def _simulate_email_send(self, recipient: str, subject: str, message: str) -> Dict[str, Any]:
...
class SMSNotification(NotificationChannel):
    ...
    def __init__(self, config: Dict[str, Any] = None):
        super().__init__(config)
        self.sms_provider = self.config.get("sms_provider", "twilio")  # twilio, africas_talking, etc.
...
class NotificationFactory:
    ...
    @classmethod
    def create_notification_channel(cls, channel_type: str, config: Dict[str, Any] = None) -> NotificationChannel:
        """
    ...
    @classmethod
    def register_notification_channel(cls, channel_type: str, channel_class: type) -> None:
        """
