...
class EasyTransactClient:
    ...
    def from_settings(cls, api_token: str | None = None) -> "EasyTransactClient":
        ...
        return cls(settings.EASYTRANSACT_API_BASE_URL.rstrip("/"), token, settings.EASYTRANSACT_HTTP_TIMEOUT_SECONDS)

    def _request(self, method: str, path: str, *, json: Mapping[str, Any] | None = None, params: Mapping[str, Any] | None = None) -> dict[str, Any]:
        try:
    ...
    def create_checkout_link(self, *, description: str, amount_xaf: int, vendor_reference: str, service_code: str = "DEPOSIT", success_url: str | None = None, cancel_url: str | None = None, expires_in_minutes: int = 1440) -> dict[str, Any]:
        if amount_xaf <= 0:
        ...
        return self._request("POST", "/api/v1/partner/transactions/checkout-link/", json=payload)
    ...
    def update_webhook_profile(self, payload: Mapping[str, Any]) -> dict[str, Any]:
        ...
        raise EasyTransactError("Easy Transact profile update contract is not configured")
